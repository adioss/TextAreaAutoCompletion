    ...
    public class XmlPositionHelperTest {
        ...
        public function shouldFindParentTagName():void {
            ...
            content = "<BOOK ISBN=\"9782212090819\" LANG=\"fr\" SUBJECT=\"applications\">"
                    + "    <AUTHOR><FIRSTNAME untruc=\"dfsd\">Jean-Christophe</FIRSTNAME>     " + "    <LASTN";
            parentTagName = XmlPositionHelper.findParentTagName(TextAreaHelper.prepareContent(content));
            Assert.assertEquals(parentTagName, "AUTHOR");

            content = "<BOOK ISBN=\"9782212090819\" LANG=\"fr\" SUBJECT=\"applications\">"
                    + "    <AUTHOR><FIRSTNAME untruc=\"dfsd\">Jean-Christophe</FIRSTNAME>     "
                    + "    <LASTNAME>Bernadac</LASTNAME>  </AUTHOR>    <AUTHOR>         " + "<FIRSTNAME>François</FIRSTNAME>        <LASTNAME>Knab</LASTNAME>"
                    + "<SIMPLETAG/>" + "                </AUTHOR>       " + " <TITLE>Construire une application XML</TITLE>" + "        <PUBLIS";
            parentTagName = XmlPositionHelper.findParentTagName(TextAreaHelper.prepareContent(content));
        ...
        public function shouldFindAssociatedTagName():void {
            ...
            var content:String;
            content = "<BOOK ISBN=\"9782212090819\" LANG=\"fr\" SUBJECT=\"applications\">" + "    <AUTHOR><FIRSTNAME untruc=\"df\\sd\">adrien</FIRST";
            ...
            content = "    <PUBLISHER>" + "\r" + "         <NAME>Eyrolles</NAME>" + "\r" + "         <PLACE>Paris</PLACE>  </PUBL";
        ...
        public function shouldNotFindAssociatedTagName():void {
            var associatedTagName:String;
            var content:String;
            content = "<BOOK ISBN=\"9782212090819\" LANG=\"fr\" SUBJECT=\"applications\">" + "    <AUTHOR><EROOR untruc=\"dfsd\">Jean-Christophe</FIRST";
            associatedTagName = XmlPositionHelper.findAssociatedTagName(content, "FIRST");
